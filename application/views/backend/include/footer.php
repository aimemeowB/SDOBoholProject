...
<!-- am chart -->
<script src="<?=base_url();?>assets/backend/pages/widget/amchart/amcharts.min.js"></script>
<script src="<?=base_url();?>assets/backend/pages/widget/amchart/serial.min.js"></script>
<!-- Todo js -->
<script type="text/javascript " src="<?=base_url();?>assets/backend/pages/todo/todo.js "></script>
<!-- Custom js -->
<script type="text/javascript" src="<?=base_url();?>assets/backend/pages/dashboard/custom-dashboard.js"></script>
<script type="text/javascript" src="<?=base_url();?>assets/backend/js/script.js"></script>
<script type="text/javascript " src="<?=base_url();?>assets/backend/js/SmoothScroll.js"></script>
<script src="<?=base_url();?>assets/backend/js/pcoded.min.js"></script>
<script src="<?=base_url();?>assets/backend/js/demo-12.js"></script>
<script src="<?=base_url();?>assets/backend/js/jquery.mCustomScrollbar.concat.min.js"></script>
<script>
var $window = $(window);
