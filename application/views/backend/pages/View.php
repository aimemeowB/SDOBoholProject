                  ...
                  <strong>Abstract:</strong> <br> <p style="margin-left: 200px;">
                    ...
                    <td>
                      <div class="d-flex justify-content-center">
                        <a href="<?php echo base_url('index.php/Admin_Controller/approveAbstract/' . $userResearch->rpaper_id); ?>"  class="btn btn-grd-info btn-lg mr-2">Approve</a>
                      </div>
                      <br>
                      <div class="d-flex justify-content-center">
                        <a href="<?php echo base_url('index.php/Admin_Controller/RejectAbstract/' . $userResearch->rpaper_id); ?>"  class="btn btn-grd-danger btn-lg mr-2">Reject</a>
                        </div>
                    </td>
                  </p>
                </div>
