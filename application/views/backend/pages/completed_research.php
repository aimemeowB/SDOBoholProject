              ...
              <div class="col-md-12 mx-auto">
                <div class="card">
                  <div class="card-header bg-warning text-white">
                    <h3 class="card-title text-center">Completed Research Papers</h3>
                  </div>
                  <div class="card-body">
                          ...
                          <?php foreach ($completed_research as $row ): ?>
                            ...
                            <td>
                              <div class="d-flex justify-content-center">
                                <a class="btn btn-info btn-sm" href="<?= site_url('admin_Controller/view_fulldocu/' . $row->rpaper_id) ?>">View</a>
                              </div>
                            </td>
                          </tr>
                          <?php endforeach; ?>
