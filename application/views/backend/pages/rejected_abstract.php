              ...
              <div class="col-md-12 mx-auto">
                <div class="card">
                  <div class="card-header bg-warning text-white">
                    <h3 class="card-title text-center">Rejected Abstract List</h3>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                          <?php foreach ($rejected_research as $row ): ?>
                            ...
                            <td>
                              <a class="btn btn-info btn-sm" href="<?= site_url('admin_Controller/view/' . $row->rpaper_id) ?>">View</a>
                              ...
                              <script>
                                  $(document).ready(function() {
                                      $(".view-button").click(function() {
                                          var rowId = $(this).data("rpaper_id");
                                          
                                          // Make AJAX request to fetch PDF content
                                          $.get("DataController/get_pdf/" + rowId, function(data) {
                                              // Embed the PDF content in the container
                                              $("#pdf-iframe").attr("src", "data:application/pdf;base64," + data);
                                          });
                                      });
                                  });
                              </script>
