            ...
            <div class="col-md-12 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                  ...
                  <strong>Full Document:</strong> <br> <p style="margin-left: 200px;">
                  <?php
                    $rpaper_id = $userResearch->rpaper_id;
                    $full_document_name = $this->Admin_users_model->get_fulldocument_name($rpaper_id);
                    $link = base_url('fulldocument_folder/' . $full_document_name);
                  ?>
                  <br>
                  <a class="btn btn-grd-success btn-round btn-lg" href="<?php echo $link; ?>" target="_blank" rel="noopener noreferrer">View Full Document</a>
                </p>
                </div>
              </div>
            </div>
