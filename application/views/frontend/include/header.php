...
<body>
    ...
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center ms-4">
          <span> (038) 412-4938 – Supt. Office</span>
        </i>
        <i class="bi bi-phone d-flex align-items-center ms-4">
          <span> (038) 411-2544 – Admin</span>
        </i>
        <i class="bi bi-phone d-flex align-items-center ms-4">
          <span> (038) 501-7550 – Supt. Office</span>
        </i>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="<?= base_url();?>index.php" class="logo me-auto me-lg-0"><img src="<?=base_url();?>assets/frontend/img/sdo_logo.png" alt="" class=""></a></h1>

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto" href="<?= base_url();?>index.php/#hero">Home</a></li>
          <li><a class="nav-link scrollto" href="<?= base_url();?>index.php/#about">About</a></li>
          <li><a class="nav-link scrollto" href="<?= base_url();?>index.php/#contact">Contact</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->

      <a href="<?= base_url();?>index.php/registration" class="book-a-table-btn scrollto d-none d-sm-flex">Register</a>
      <a href="<?= base_url();?>index.php/login" class="book-a-table-btn scrollto d-none d-sm-flex">Login</a>
      <a href="<?= base_url();?>index.php/admin" class="book-a-table-btn scrollto d-none d-sm-flex">Admin Login</a>
