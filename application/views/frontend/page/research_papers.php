            ...
            <div class="search-field d-none d-md-block">
              <form class="d-flex align-items-center h-100" action="<?= base_url('index.php/search') ?>" method="get">
                <div class="input-group">
                  ...
                  <input type="text" name="search" class="form-control bg-secondary border-0" placeholder="Search keywords">
                  <button class="btn bg-gradient-light btn-sm" type="submit">Search</button>
                </div>
              </form>
            </div>
            ...
            <tbody>
              <?php foreach ($user_research as $key => $userResearch): ?>
                    <tr>
                      ...
                      <td>
                      <center>
                      <a class="btn btn-info btn-sm" href="<?= site_url('Users_Controller/viewfulldocu/' . $userResearch->rpaper_id) ?>">View</a>
                      </center>
                      </td>
                    </tr>
              <?php endforeach; ?>
