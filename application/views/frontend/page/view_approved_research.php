200        <!-- partial -->
        <div class="main-panel">
          ...
          <strong>Full Document:</strong> <br> <p style="margin-left: 200px;">
            <?php
              $rpaper_id = $userResearch->rpaper_id;
              $full_document_name = $this->Users_model->get_fulldocument_name($rpaper_id);
              $link = base_url('fulldocument_folder/' . $full_document_name);
            ?>
            <br>
            <a class="btn bg-gradient-success btn-sm" href="<?php echo $link; ?>" target="_blank" rel="noopener noreferrer">View Full Document</a>
          </p>
